...
def show_instructions(grid_size):
  pygame.init()
  ...
  while running:
      ...
      display_message(screen, "Press 'z' to save your maze", 24, (10, 260), (0, 0, 0))
      display_message(screen, "Press 'l' to load a maze", 24, (10, 290), (0, 0, 0))
